...
namespace model_iso_horseshoe_plus_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_iso_horseshoe_plus");
    reader.add_event(61, 59, "end", "model_iso_horseshoe_plus");
    return reader;
}
#include <stan_meta_header.hpp>
class model_iso_horseshoe_plus
  : public stan::model::model_base_crtp<model_iso_horseshoe_plus> {
private:
        int n_groups_stan;
...
public:
    model_iso_horseshoe_plus(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_iso_horseshoe_plus_namespace::model_iso_horseshoe_plus";
        ...
        try {
            ...
            validate_non_negative_index("gamma_base_sq", "(n_groups_stan + 1)", (n_groups_stan + 1));
            num_params_r__ += (n_groups_stan + 1);
            current_statement_begin__ = 23;
            validate_non_negative_index("gamma_scale_sq", "(n_groups_stan + 1)", (n_groups_stan + 1));
            num_params_r__ += (n_groups_stan + 1);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("gamma_base_sq", "(n_groups_stan + 1)", (n_groups_stan + 1));
        context__.validate_dims("parameter initialization", "gamma_base_sq", "vector_d", context__.to_vec((n_groups_stan + 1)));
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_base_sq((n_groups_stan + 1));
        size_t gamma_base_sq_j_1_max__ = (n_groups_stan + 1);
        ...
        pos__ = 0U;
        validate_non_negative_index("gamma_scale_sq", "(n_groups_stan + 1)", (n_groups_stan + 1));
        context__.validate_dims("parameter initialization", "gamma_scale_sq", "vector_d", context__.to_vec((n_groups_stan + 1)));
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_scale_sq((n_groups_stan + 1));
        size_t gamma_scale_sq_j_1_max__ = (n_groups_stan + 1);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                gamma_base_sq = in__.vector_lb_constrain(0.0, (n_groups_stan + 1), lp__);
            else
                gamma_base_sq = in__.vector_lb_constrain(0.0, (n_groups_stan + 1));
            current_statement_begin__ = 23;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> gamma_scale_sq;
            (void) gamma_scale_sq;  // dummy to suppress unused var warning
            if (jacobian__)
                gamma_scale_sq = in__.vector_lb_constrain(0.0, (n_groups_stan + 1), lp__);
            else
                gamma_scale_sq = in__.vector_lb_constrain(0.0, (n_groups_stan + 1));
            ...
            validate_non_negative_index("gamma_sq", "(n_groups_stan + 1)", (n_groups_stan + 1));
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> gamma_sq((n_groups_stan + 1));
            ...
            for (int i = 1; i <= (n_groups_stan + 1); ++i) {
                ...
                stan::model::assign(theta, 
                            ...
                            (1.0 / stan::math::sqrt((1.0 + (1.0 / (((alpha_scale_stan_sq * tau_glob_sq) * get_base1(lambda_sq, i, "lambda_sq", 1)) * get_base1(gamma_sq, i, "gamma_sq", 1)))))), 
            ...
            current_statement_begin__ = 31;
            size_t gamma_sq_j_1_max__ = (n_groups_stan + 1);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_iso_horseshoe_plus_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_base_sq = in__.vector_lb_constrain(0.0, (n_groups_stan + 1));
        size_t gamma_base_sq_j_1_max__ = (n_groups_stan + 1);
        for (size_t j_1__ = 0; j_1__ < gamma_base_sq_j_1_max__; ++j_1__) {
            vars__.push_back(gamma_base_sq(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_scale_sq = in__.vector_lb_constrain(0.0, (n_groups_stan + 1));
        size_t gamma_scale_sq_j_1_max__ = (n_groups_stan + 1);
        for (size_t j_1__ = 0; j_1__ < gamma_scale_sq_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            current_statement_begin__ = 31;
            validate_non_negative_index("gamma_sq", "(n_groups_stan + 1)", (n_groups_stan + 1));
            Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_sq((n_groups_stan + 1));
            stan::math::initialize(gamma_sq, DUMMY_VAR__);
            stan::math::fill(gamma_sq, DUMMY_VAR__);
            current_statement_begin__ = 32;
            validate_non_negative_index("normalized_alpha", "(n_groups_stan + 1)", (n_groups_stan + 1));
    ...
    std::string model_name() const {
        return "model_iso_horseshoe_plus";
    }
...
typedef model_iso_horseshoe_plus_namespace::model_iso_horseshoe_plus stan_model;
#ifndef USING_R
